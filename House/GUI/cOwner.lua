...
addEventHandler("open:houseowner",root,function()
	if(isLoggedin())then
		if(getElementData(lp,"ElementClicked")==false)then
			...
			if(isElement(Lakeside.Blurbox[1])or isElement(Lakeside.Blurbox[2]))then
				exports.blur_box:destroyBlurBox(Lakeside.Blurbox[1])
			end
			...
			Lakeside.Button[2]=dgsCreateButton(5,235,135,35,"Enter house",false,Lakeside.Window[1],_,_,_,_,_,_,tocolor(50,50,50,255),tocolor(90,90,90,255),tocolor(10,10,10,255),true)
			Lakeside.Button[3]=dgsCreateButton(160,235,135,35,"Sell house",false,Lakeside.Window[1],_,_,_,_,_,_,tocolor(50,50,50,255),tocolor(90,90,90,255),tocolor(10,10,10,255),true)
			Lakeside.Button[4]=dgsCreateButton(5,195,135,35,"Change door state",false,Lakeside.Window[1],_,_,_,_,_,_,tocolor(50,50,50,255),tocolor(90,90,90,255),tocolor(10,10,10,255),true)
